...
PARAMETER_SECTION
  ...
  init_bounded_number psi(-100.,100.,1)               //Logistic-normal psi parameter for fishery comp
  ...
  init_bounded_number psi_surv(-100.,100.,1)        //Logistic-normal psi parameter for survey comp
