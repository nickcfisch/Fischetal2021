...
//Dirichlet-Multinomial Linear Parameterization
...
//Dirichlet-Multinomial
  ...
  if(SS_fishery(i)>0){
  L2 += -1*(gammln(SS_fishery(i)+1)-sum(gammln(SS_fishery(i)*obs_fishery_comp(i)+ones))+gammln(Beta(i))-gammln(SS_fishery(i)+Beta(i))+sum(gammln(SS_fishery(i)*obs_fishery_comp(i)+Beta(i)*pred_fishery_comp(i))-gammln(Beta(i)*pred_fishery_comp(i)))); //Simplified
  }}
...
//Fisheries-independent likelihoods
  ...
  //Thorson Linear
  if(SS_FIM(i)>0){
  L4 += -1*(gammln(SS_FIM(i)+1)-sum(gammln(SS_FIM(i)*obs_FIM_comp(i)+ones))+gammln(Beta_FIM(i))-gammln(SS_FIM(i)+Beta_FIM(i))+sum(gammln(SS_FIM(i)*obs_FIM_comp(i)+Beta_FIM(i)*pred_FIM_comp(i))-gammln(Beta_FIM(i)*pred_FIM_comp(i)))); //Simplified
  }
