...
//Multinomial Iteratively Weighted using Francis (2011) TA1.8
...
PARAMETER_SECTION
  ...
  init_vector SS_fishery(fyear,lyear,-1)           //Effective sample size for Fishery
  init_vector SS_FIM(fyear,lyear,-1)               //FIM effective sample size
  ...
  open_r_file("SimSCAA.rdat");
   ...
   close_r_vector();
    ...
    close_r_matrix();
     ...
     wrt_r_complete_vector("SS_fishery",SS_fishery);           //Effective sample size for Fishery
     wrt_r_complete_vector("SS_FIM",SS_FIM);               //FIM effective sample size
