...
//Robust Multinomial (Starr et al., 2009) Iteratively Weighted using Francis (2011)
  ...
  open_r_file("SimSCAA.rdat");
   ...
   close_r_vector();
    ...
    close_r_matrix();
     ...
     wrt_r_complete_vector("SS_fishery",SS_fishery);     
     wrt_r_complete_vector("SS_FIM",SS_FIM);    
